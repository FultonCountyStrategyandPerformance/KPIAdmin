 ...
 */
    ...
    class dbo_PerformanceManagement_ProgramValuesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '[dbo].[PerformanceManagement_ProgramValues]');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('dbo_PerformanceManagement_ProgramValuesssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('dbo_PerformanceManagement_ProgramValuesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridDeleteHandler() { return 'dbo_PerformanceManagement_ProgramValues_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'dbo_PerformanceManagement_ProgramValuesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new dbo_PerformanceManagement_ProgramValuesPage("dbo.PerformanceManagement_ProgramValues.php", "dbo_PerformanceManagement_ProgramValues", GetCurrentUserGrantForDataSource("dbo.PerformanceManagement_ProgramValues"), 'UTF-8');
        $Page->SetShortCaption('Dbo.PerformanceManagement ProgramValues');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Dbo.PerformanceManagement ProgramValues');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("dbo.PerformanceManagement_ProgramValues"));
